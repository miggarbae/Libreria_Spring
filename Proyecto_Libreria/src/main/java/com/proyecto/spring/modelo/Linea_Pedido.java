...
public class Linea_Pedido {
	...
	public String toString() {
		return "Linea_Pedido [id_linea_pedido=" + id_linea_pedido + ", pedido=" + pedido + ", producto=" + producto
				+ ", cantidad=" + cantidad + ", precio_unitario=" + precio_unitario + ", precio_total=" + precio_total
				+ "]";
	}
}
